    ...
    <div class="row">
      <div class="col-lg-12 text-center">
        ...
        <div class="row justify-content-center">
        	<form class="form-inline" action="http://localhost:8080/HMS/DiagnosisController" method="post">
        ...
        <div class="row justify-content-center">
        	<form class="form-inline" action="http://localhost:8080/HMS/DiagnosisController" method="post">
        		<input type="hidden" name="source" value="issuediag">
        		<input type="hidden" name="patientId" value=<%= patient.getPatientId() %>>
        		<input type="hidden" name="patientName" value=<%= patient.getName() %>>
			  <button class="btn btn-dark btn-sm my-0" type="submit">Add Diagnosis</button>
			</form>
        </div>
